...
insert into board (bno,userid,title,contents) values (1,'j2ee','test','게시물 테스트');
insert into board (bno,userid,title,contents) values (2,'j2ee','test','게시물 테스트');
insert into board (bno,userid,title,contents) values (3,'j2ee','test','게시물 테스트');
